...
public class Answer02_StringBuffer {
    ...
    public String[] solution(int n, int[] arr1, int[] arr2) {
        ...
        for (int i = 0; i < n; i++){
            ...
            StringBuffer orString = new StringBuffer(Integer.toBinaryString(orValue)); // 10진수 => 2진수

            while (orString.length() < n){
                orString.insert(0, "0");
            }

            answer[i] = orString.toString().replace("1","#").replace("0", " ");
        }
    ...
    public static void main(String[] args) {
        ...
        Answer02_StringBuffer T = new Answer02_StringBuffer();
        int[] n = {5, 6};
        int[][] arr1 = {
