...
public class Main {
    ...
    public boolean isAlpha(char lt, char rt){

        if ((Character.isLowerCase(lt) || Character.isUpperCase(lt)) &&
                (Character.isLowerCase(rt) || Character.isUpperCase(rt))){
            return true;
        }
    ...
    public String solution(String string) {
        ...
        while (lt < rt){
            if (Character.isAlphabetic(charArray[lt]) && Character.isAlphabetic(charArray[rt])) {
                ...
                charArray[rt] = temp;
                System.out.println(lt + " " + rt + Arrays.toString(charArray) + " " + charArray[lt] + " " + charArray[rt] );
                System.out.println(Arrays.toString(charArray));
            }
            lt++;
            rt--;
